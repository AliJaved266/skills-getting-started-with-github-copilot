              ...
              .map(
                (participant) => `
                  <li class="participant-row">
                    ...
                    <button class="remove-participant" type="button" data-email="${escapeHtml(participant)}" aria-label="Unregister ${escapeHtml(participant)}" title="Unregister participant">&#128465;</button>
                  </li>`
              )
              .join("")
